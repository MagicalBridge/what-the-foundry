...
contract IDOlounchUpgradeableV2 is Initializable, UUPSUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function get_MAX_CONTRIBUTION() external pure returns (uint256) {
